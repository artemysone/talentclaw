      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4 text-text-secondary text-[15px] leading-relaxed">
          ...
          <p>
            ...
            <a href="https://github.com/artemyshq/talentclaw" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
              github.com/artemyshq/talentclaw
            </a>.
          </p>
        </div>
      </div>

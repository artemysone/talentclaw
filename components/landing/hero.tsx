...
function CopyableCode({ text }: { text: string }) {
  ...
  return (
    ...
    >
      <code className="text-emerald-600 font-mono">{text}</code>
    ...
    <section className="px-5 pt-20 pb-12 relative overflow-hidden">
      <div className="max-w-[860px] mx-auto text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <a
            href="/install.sh"
            className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-emerald-600 text-white font-medium text-[1rem] hover:bg-emerald-500 hover:shadow-[0_4px_16px_var(--color-accent-glow)] transition-all"
          >
            Get TalentClaw — Free
          </a>

          <p className="text-[0.8rem] text-text-muted">
            macOS &middot; Free &middot; No account required
          </p>

          <p className="text-[0.8rem] text-text-muted mt-2 inline-flex items-center gap-1.5 flex-wrap justify-center">
            ...
            Already use Claude?{" "}
            <CopyableCode text="/plugin install talentclaw" />
          </p>
        </div>
      </div>
    </section>
